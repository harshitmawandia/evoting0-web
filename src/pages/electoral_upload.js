...
function ElectoralUpload() {
	...
	const { values, errors, touched, handleBlur, handleSubmit, handleChange } = useFormik({
		...
		onSubmit: (values) => {
            ...
            if (election_name === "" || election_starttime === "" || election_endtime === "" || election_date === "" || candidate_file === undefined || voter_file === undefined) {
                alert("Please fill in all the fields");
                return;
            }
            let votes = 1;
            // if numVotes is non zero then append it to the form data
            if (numVotes !== 0 && numVotes !== undefined && numVotes !== null && numVotes !== ""){
                // console.log("here");
                votes = numVotes;
            }
            ...
            axios.post("http://10.17.6.59/api/admin/createElection", data, {
            headers: { Authorization: `Bearer ${token}` }}).then((res) => {
                fetch("http://10.17.6.59/api/admin/addCandidates",
                {
                    method: "POST",
                    headers: {
                ...
                fetch("http://10.17.6.59/api/admin/addElectorate",
                {
                    method: "POST",
                    headers: {
                        'Authorization': `Bearer ${token}`
				...
				<div class='container'>
                    <div class = "row justify-content-center">
                        <div class = "col-4 justify-content-center align-middle">
                            <label for="fname">Name of Electoral College</label><br/>
                        </div>
                        <div class="col-6 justify-content-center">
                            <input type="text" id="name" name="name" required onChange={handleChange} onBlur={handleBlur} value={values.name}/>
                        </div>
                    </div>
                    <br/>
                    <br/>
                    <div class = "row justify-content-center">
                        <div class = "col-7 justify-content-center">
                            <label for="fname">Upload the list of candidates for the position</label>
                        </div>
                        <div class="col-3 justify-content-center">
                            <input type="file" id="candidates" name="candidate_file" required onChange={handleChange} onBlur={handleBlur} value={values.candidates}/>
                        </div>
                    </div>
                    <br/>
                    <br/>
                    <div class = "row justify-content-center">
                        <div class = "col-7 justify-content-center">
                            <label for="fname">Upload the list of voters for the position</label><br/>
                        </div>
                        <div class="col-3 justify-content-center">
                            <input type="file" id="voters" name="voter_file" required onChange={handleChange} onBlur={handleBlur} value={values.voters}/>
                        </div>
                    </div>
                    <br/>
                    <br/>
                    <div class = "row justify-content-center">
                        ...
                        <div class="col-3 justify-content-center">
                            <input type="date" id="date" name="date" required onChange={handleChange} onBlur={handleBlur} value={values.date}/>
                        </div>
                    </div>
                    <br/>
                    <br/>
                    <div class = "row justify-content-center">
                        ...
                        <div class="col-3 justify-content-center">
                            <input type="time" id="starttime" name="starttime" required onChange={handleChange} onBlur={handleBlur} value={values.starttime}/>
                        </div>
                    </div>
                    <br/>
                    <br/>
                    <div class = "row justify-content-center">
                        ...
                        <div class="col-3 justify-content-center">
                            <input type="time" id="endtime" name="endtime" required onChange={handleChange} onBlur={handleBlur} value={values.endtime}/>
                        </div>
                    </div>
                    <br/>
                    <br/>
                    <div class = "row justify-content-center">
                        <div class = "col-7 justify-content-center">
                            <label for="numVotes">Number of Votes per Voter (Default : 1)</label>
                        </div>
                        <div class="col-3 justify-content-center">
                            <input type="number" id="numVotes" name="numVotes" required onChange={handleChange} onBlur={handleBlur} value={values.numVotes}/>
                        </div>
                    </div>
                    <br/>
                    <br/>
